        ...
        const worksheetData = exportData.map(item => (
            {
                ...
                'Total Surface < 1ha': item.total_surface_lt_1,
                'Features 1-3ha': item.features_1_to_3,
                'Total Surface 1-3ha': item.total_surface_1_to_3,
                'Features 3-8ha': item.features_3_to_8,
                'Total Surface 3-8ha': item.total_surface_3_to_8,
                'Features > 8ha': item.features_gt_8,
                'Total Surface > 8ha': item.total_surface_gt_8,
